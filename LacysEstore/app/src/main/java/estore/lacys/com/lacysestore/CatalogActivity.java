...
import estore.lacys.com.lacysestore.Catalog;
import estore.lacys.com.lacysestore.CatalogAdapter;
...
public class CatalogActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Create the list
        ListView listViewCatalog = (ListView) findViewById(R.id.list_item);
        listViewCatalog.setAdapter(new CatalogAdapter(mProductList, getLayoutInflater(), false));
