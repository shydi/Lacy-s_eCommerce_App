...
public class womensCatalog extends Activity
{
    private List<Catalog> wProductList;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        wProductList = womensHelper.getCatalog(getResources());

        // Create the list
        ListView listViewCatalog = (ListView) findViewById(R.id.ListViewCatalog);
        listViewCatalog.setAdapter(new mensAdapter(wProductList, getLayoutInflater(), false));
        ...
        listViewCatalog.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position,
                                    long id) {
                Intent productDetailsIntent = new Intent("estore.lacys.com.lacysestore.clothes.womensDetails");
                productDetailsIntent.putExtra(womensHelper.PRODUCT_INDEX, position);
